  ...
  return (
    <div>
      ...
      <button
        onClick={onClick}
        type="submit"
        className="cursor-pointer inline-flex items-center justify-center px-5 py-2.5 text-sm font-medium text-white bg-blue-700 rounded-lg focus:ring-4 focus:ring-blue-200 disabled:opacity-70 disabled:cursor-not-allowed"
        disabled={disabled}
      >
        {disabled ? (
          <svg
